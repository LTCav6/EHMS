...
public class Login extends javax.swing.JFrame {
            ...
            if(rs.isBeforeFirst()){
                while(rs.next()){
                    ...
                    if(password.equals(pw)){
                        ...
                        Employee signInEmp = new Employee(rs.getInt("StaffID"), rs.getString("FirstName"),rs.getString("LastName"), con);
                        ...
                        if(level == 3){
                            ...
                            LevelOne l1 = new LevelOne(con, signInEmp);
    ...
    public static void establishConnection() throws SQLException{
        try {
            String strSshUser = "lcavanau"; // SSH loging username
            String strSshPassword = "Abby0422"; // SSH login password
